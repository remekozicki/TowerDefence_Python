...
class Menu:
    ...
    def add_buttons(self):
        ...
        play_button = Button((self.screen.get_width() - button_width) // 2,
                             (self.screen.get_height() - self.height) // 2 + 50, button_width, button_height, 'PLAY',
                             lambda: self.hide_menu())
        ...
        quit_button = Button((self.screen.get_width() - button_width) // 2,
                             (self.screen.get_height() - self.height) // 2 + 290, button_width, button_height, 'QUIT',
